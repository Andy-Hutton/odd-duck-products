...
function renderChart() {
  ...
  for (let i = 0; i < Product.allProductsArray.length; i++) {
    let thisProduct = Product.allProductsArray[i];
    labelArray.push(thisProduct.name);
    clicksArray.push(thisProduct.clicks);
    viewsArray.push(thisProduct.views);
  }
